...
public class Menu {
    ...
    public static void NewTree(ArrayList<Product>stock){
        ...
        stock.add(tree);
        DDBBManager.addProduct(new ArrayList<Product>(Arrays.asList(tree)));
    ...
    public static void NewFlower(ArrayList<Product>stock){
        ...
        stock.add(flower);
        DDBBManager.addProduct(new ArrayList<Product>(Arrays.asList(flower)));
    ...
    public static void NewDecor(ArrayList<Product>stock){
        ...
        DDBBManager.addProduct(new ArrayList<Product>(Arrays.asList(decoration)));
